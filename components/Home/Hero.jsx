  ...
  return (
    <div className='w-full items-center relative flex flex-col justify-between    h-[100vh]'>
        <div className='absolute -z-10 w-full h-full'>
            <Image src={`/image/hero.png`} width={2000} height={1000} className='w-full h-full object-cover'/>
        </div>
        <Navbar/>
        <div className='flex flex-col gap-2 w-full items-center'>
            ...
            <button className='px-8 py-[10px] hover:scale-110 transition-all rounded-[14px] bg-[#F2C300] text-white mt-3'>TALK TO US</button>
            <button className='px-8 py-[10px] hover:bg-[#F2C300] hover:text-white transition-all rounded-[14px] border-2 border-[#F2C300] text-[#F2C300] mt-3'>ABOUT US</button>
